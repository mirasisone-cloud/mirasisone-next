    ...
    <main className="thanks-page">
      ...
      <section className="thanks-shell">
        ...
        <p className="thanks-lead">
          <span>あなたの空間に、</span>
          <span>まだ誰も見たことのない光を灯す準備が始まりました。</span>
          <span>いただいたメッセージは、</span>
          <span>私たちのスクリーンにしっかり投影されました。</span>
        </p>
        <p className="thanks-copy">
          <span>内容を拝見し、2営業日以内にご連絡いたします。</span>
          <span>どんな空間が、どんな物語を待っているのか、</span>
          <span>私たちも今からワクワクしています。</span>
        </p>
